...
web/bootstrap:
	@cd web && wget https://github.com/twbs/bootstrap/releases/download/v3.0.3/bootstrap-3.0.3-dist.zip && unzip bootstrap-3.0.3-dist.zip && mv dist bootstrap && rm bootstrap-3.0.3-dist.zip
